...
//        return inflater.inflate(R.layout.fragment_green, container, false);
        ...
        View layout = inflater.inflate(R.layout.fragment_green, container, false);

        TextView eltexto=layout.findViewById(R.id.txtTexto);
        Button elboton=layout.findViewById(R.id.btnBotton);

        elboton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                eltexto.setText("Si se pudo!!!!");
